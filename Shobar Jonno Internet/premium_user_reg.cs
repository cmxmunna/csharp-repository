...
{
    public partial class premium_user_reg : Form
    {
        string cs = ConfigurationManager.ConnectionStrings["db"].ConnectionString;

        public premium_user_reg()
        {
            InitializeComponent();
        }

        private void premium_user_reg_Load(object sender, EventArgs e)
        {
        ...
        private void register_Click(object sender, EventArgs e)
        {
            ...
            command.Parameters.AddWithValue("@collegename", emptyvalue.Text);
        ...
        private void comnamebox_Leave(object sender, EventArgs e)
        {
            emptycomname.Clear();
        }
